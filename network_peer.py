...
class PrivateChatPage(tk.Frame):
    ...
    def open_chatroom(self):
        ...
        line = tk.Label(chatroom, width=450, bg="#f2f0f6")
        ...
        labelBottom = tk.Label(chatroom, bg="#f2f0f6", height=80)

        labelBottom.place(relwidth=1, rely=0.825)

        self.entryMsg = tk.Entry(
           labelBottom, bg="#f2f0f6", fg="#1E1E1E", font=("Courier New", 13), insertbackground="#f2f0f6"
        )
...
class ChatPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.f1 = tk.Frame(self, background="#1E1E1E") 
        self.f2 = tk.Frame(self, background="#1E1E1E")  
        self.f3 = tk.Frame(self, background="#1E1E1E") 
